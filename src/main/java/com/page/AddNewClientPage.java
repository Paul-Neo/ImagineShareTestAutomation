...
//	private By archiveBtn = By.xpath("//button[text()='Archive Clients']");
	...
	private By archiveLists = By.xpath(
			"//div[@class='table-cell' and @style='white-space: initial; min-width: 150px;']//div[@class='overflow-hidden']");
	...
	private By phoneTypeDropdown = By
			.xpath("//strong[text()='Primary Phone']/following::div[@class='css-1wy0on6 react-select__indicators'][1]");
...
//		refreshPage(driver);
	...
	public boolean isClientGeneralInfoCorrect(String clientName, String clientIdentifier, String engagementTypes) throws InterruptedException {
		...
		if (actualCLientName.equals(clientName) && actualClientIdentifier.equals(clientIdentifier)
	...
	public void selectClientFromArchivedList(String archivedClient) throws InterruptedException {
		...
		By selectedArchivedClient = By
				.xpath("//div[contains(text(),'" + archivedClient + "')]/preceding::input[@type='checkbox'][1]");
